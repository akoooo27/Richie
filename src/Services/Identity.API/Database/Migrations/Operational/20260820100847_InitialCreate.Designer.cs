...
namespace Identity.API.Database.Migrations.Operational
{
    ...
    [Migration("20260820100847_InitialCreate")]
            ...
            modelBuilder.Entity("Duende.IdentityServer.EntityFramework.Entities.DeviceFlowCodes", b =>
                {
                    ...
                    b.ToTable("device_flow_codes", "operational");
                });
            ...
            modelBuilder.Entity("Duende.IdentityServer.EntityFramework.Entities.PersistedGrant", b =>
                {
                    ...
                    b.ToTable("persisted_grants", "operational");
                });
            ...
            modelBuilder.Entity("Duende.IdentityServer.EntityFramework.Entities.PushedAuthorizationRequest", b =>
                {
                    ...
                    b.HasIndex("ExpiresAtUtc")
                        .HasDatabaseName("ix_par_expires_at_utc");

                    b.HasIndex("ReferenceValueHash")
                        .IsUnique()
                        .HasDatabaseName("ix_par_reference_value_hash");

                    b.ToTable("par", "operational");
                });
            ...
            modelBuilder.Entity("Duende.IdentityServer.EntityFramework.Entities.SamlLogoutSession", b =>
                {
                    ...
                    b.ToTable("saml_logout_sessions", "operational");
                });
            ...
            modelBuilder.Entity("Duende.IdentityServer.EntityFramework.Entities.SamlLogoutSessionRequestIndex", b =>
                {
                    ...
                    b.ToTable("saml_logout_session_request_indices", "operational");
                });
            ...
            modelBuilder.Entity("Duende.IdentityServer.EntityFramework.Entities.SamlSigninState", b =>
                {
                    ...
                    b.ToTable("saml_signin_states", "operational");
                });
            ...
            modelBuilder.Entity("Duende.IdentityServer.EntityFramework.Entities.ServerSideSession", b =>
                {
                    ...
                    b.ToTable("server_side_sessions", "operational");
                });
